...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.infy.store.domain.PersistentToken.class.getName(), jcacheConfiguration);
            cm.createCache(com.infy.store.domain.User.class.getName() + ".persistentTokens", jcacheConfiguration);
